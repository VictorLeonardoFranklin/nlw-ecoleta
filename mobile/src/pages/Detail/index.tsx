...
const Detail = () => {
    ...
    function handlerWhatsApp() {
        Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Ola tenho interesse sobre coleta de resíduos.`)
    }

    function handlerComposeEmail() {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={styles.footer}>
                ...
                <RectButton style={styles.button} onPress={handlerComposeEmail}>
